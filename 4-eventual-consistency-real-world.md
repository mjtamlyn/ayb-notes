...
aka siblings. Now we don't store timestamps, but that's observed. So we tell causality with something like commit hashes, called vector clocks. Riak will actually give you back multiple values.
